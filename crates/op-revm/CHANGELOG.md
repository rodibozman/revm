...
## [11.0.0](https://github.com/rodibozman/revm/compare/op-revm-v10.0.0...op-revm-v11.0.0) - 2025-09-17

### Added

- *(op-revm)* Add an option to disable "fee-charge" on `op-revm` ([#2980](https://github.com/rodibozman/revm/pull/2980))
- [**breaking**] Remove kzg-rs ([#2909](https://github.com/rodibozman/revm/pull/2909))

### Fixed

- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/rodibozman/revm/pull/2978))
- *(op-revm)* clear enveloped_tx for deposit txs in build_fill and align docs ([#2957](https://github.com/rodibozman/revm/pull/2957))

### Other

- prealloc few frames ([#2965](https://github.com/rodibozman/revm/pull/2965))
- treat empty input as zero operator fee in operator_fee_charge ([#2973](https://github.com/rodibozman/revm/pull/2973))
- add SECURITY.md ([#2956](https://github.com/rodibozman/revm/pull/2956))
- *(op-revm)* rm redundant phantom ([#2943](https://github.com/rodibozman/revm/pull/2943))
- *(op-revm)* add serialize DepositTransactionParts test ([#2942](https://github.com/rodibozman/revm/pull/2942))
- *(handler)* provide `&CallInputs`to`PrecompileProvider::run` ([#2921](https://github.com/rodibozman/revm/pull/2921))
