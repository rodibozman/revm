...
## [6.2.3](https://github.com/rodibozman/revm/compare/revm-bytecode-v6.2.2...revm-bytecode-v6.2.3) - 2025-09-24

### Fixed

- *(bytecode)* exclude MLOAD from modifies_memory and update test ([#3004](https://github.com/rodibozman/revm/pull/3004))
- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/rodibozman/revm/pull/2978))

### Other

- use offset_from_unsigned ([#2999](https://github.com/rodibozman/revm/pull/2999))
