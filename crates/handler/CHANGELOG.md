...
## [11.0.0](https://github.com/rodibozman/revm/compare/revm-handler-v10.0.0...revm-handler-v11.0.0) - 2025-09-17
...
- interpreter_result_mut should return mutable reference ([#2941](https://github.com/rodibozman/revm/pull/2941))
...
- Fix infinite recursion in EthPrecompiles PrecompileProvider methods ([#2962](https://github.com/rodibozman/revm/pull/2962))
- add SECURITY.md ([#2956](https://github.com/rodibozman/revm/pull/2956))
- update `EthFrame::invalid` visibility ([#2947](https://github.com/rodibozman/revm/pull/2947))
- remove unused generic from validate_tx_env and fix call site ([#2946](https://github.com/rodibozman/revm/pull/2946))
