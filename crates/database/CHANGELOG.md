...
## [7.0.6](https://github.com/rodibozman/revm/compare/revm-database-v7.0.5...revm-database-v7.0.6) - 2025-09-17
...
- *(database)* avoid panic by conditionally using block_in_place ([#2927](https://github.com/rodibozman/revm/pull/2927))
