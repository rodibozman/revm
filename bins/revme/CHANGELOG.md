...
## [8.0.0](https://github.com/rodibozman/revm/compare/revme-v7.2.2...revme-v8.0.0) - 2025-09-17
...
- support 0x prefix in evmrunner hex input ([#2970](https://github.com/rodibozman/revm/pull/2970))
- *(revme)* Avoid panic on non-UTF filenames in statetest runner ([#2948](https://github.com/rodibozman/revm/pull/2948))

### Other

- pretty print state in revme statetest ([#2979](https://github.com/rodibozman/revm/pull/2979))
- Fix CLI exit code for invalid bytecode input ([#2968](https://github.com/rodibozman/revm/pull/2968))
